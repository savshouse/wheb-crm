...
// Uses service role so calendar apps can fetch without a browser session.
// The uid path segment is the user's UUID — hard to guess, acts as the per-user secret.
